...
const MOCK_USER_REQUESTS: UserRequest[] = [
  ...
  },
  {
    id: "REQ-009",
    budget: 40000000,
    purpose: "Đồ hoạ / Render",
    note: "Dùng Blender, After Effects",
    buildItems: [],
    status: "pending",
...
export function PCBuilderPage() {
  ...
  const [myRequests, setMyRequests] =
    useState<UserRequest[]>(MOCK_USER_REQUESTS);
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span
                          className={`text-xs px-2 py-0.5 rounded-full ${isDark ? "bg-white/10 text-gray-400" : "bg-gray-100 text-gray-500"}`}
                        >
                    ...
                    {comp.product ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {available.map((product) => (
                          <button
                            key={product.id}
                            onClick={() =>
                              selectProduct(comp.category, product)
                            }
                      ...
                      <div
                        className={`text-center py-8 rounded-lg ${isDark ? "bg-slate-900/30" : "bg-gray-50"}`}
                      >
                        <p
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Lấy từ thanh ngân sách bạn đã chọn
                  </p>
                </div>
                <div>
                  <label
