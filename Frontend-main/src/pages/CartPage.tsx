      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="w-8 h-8 bg-purple-500/30 rounded-lg flex items-center justify-center hover:bg-purple-500/50 transition-colors"
                      >
        ...
        <div className="lg:col-span-1">
          <div className="bg-gradient-to-br from-purple-900/40 to-purple-800/20 backdrop-blur-sm rounded-xl border border-purple-500/30 p-6 sticky top-24">
            <h2 className="text-2xl font-bold mb-6 text-purple-400">Tổng đơn hàng</h2>
            <div className="space-y-4 mb-6">
              ...
              {subtotal < 10000000 && subtotal > 0 && (
                <div className="text-sm text-yellow-400 bg-yellow-500/10 p-3 rounded-lg border border-yellow-500/30">
                  Mua thêm {(10000000 - subtotal).toLocaleString('vi-VN')}₫ để được miễn phí vận
                  chuyển
                </div>
              )}
