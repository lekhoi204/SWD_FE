                ...
                <div className="relative">
                  ...
                  {userMenuOpen && (
                    <>
                      ...
                      >
                        <div
                          className={`px-4 py-3 border-b ${theme.isDark ? "border-purple-500/20" : "border-gray-100"}`}
                        >
                          <p
                            className={`font-semibold text-sm ${theme.isDark ? "text-white" : "text-gray-900"}`}
                          >
                            {auth.user?.name}
                          </p>
                          <p
                            className={`text-xs truncate ${theme.isDark ? "text-gray-400" : "text-gray-500"}`}
                          >
                            {auth.user?.email}
                          </p>
                        </div>
