    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#0f0e17' }}>
      ...
      <aside
        style={{
          ...
          minHeight: '100vh',
          background: 'linear-gradient(180deg, #1a1035 0%, #0f0e17 100%)',
      ...
      >
        <div style={{ padding: '20px', borderBottom: '1px solid rgba(139,92,246,0.1)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontSize: '18px', fontWeight: 700, color: '#fff' }}>Admin Panel</span>
